...
export default function CoverLetterMaker() {
    ...
    const getCvText = () => {
        ...
        const updatedCvText = `Dear Recruiter of ${company},\nNice to meet you! My name is ${name} and I’m writing to you to express my interest in the position as a ${role} at this company. With nearly two years of experience in Data Analyst (with great focus on the Information Systems) at work, during collage and on various personal projects, and having just completed my studies for the Bachelor Degree in Industrial Engineering and Management at Azrieli - Academic College of Engineering, I’m enthusiastic about the opportunity to join your innovative team.\nWith a strong foundation in Data Analyst, including extensive experience with SQL,Paython and Excel. I am confident in my ability to contribute effectively to your company. My background in Data Analyst in an Scrum Agile in the civil service, coupled with my academic achievements in Industrial Engineering , positions me well to thrive in a dynamic and innovative environment like yours. Additionally, my goal to work internationally aligns perfectly with the global nature of your company, and I am eager to bring my skills and enthusiasm to your esteemed team.\nLooking forward to hearing from you, I wish you a nice day!\nSincerely,\n${name}`;
